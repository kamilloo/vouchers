                ...
                <div class="col-md-4">
                    <div class="single-feature d-flex flex-wrap justify-content-between">
                        ...
                        <div class="desc">
                            ...
                            <p>Dopasuj platformę do swoich potrzebna, wybierz jedną z templatek lub stwórz swoją stronę.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div id="mc_embed_signup">
                        <form target="_blank" novalidate action="https://spondonit.us12.list-manage.com/subscribe/post?u=myvouchers&id=6cda572e7f" method="get" class="subscription relative">
