...
@section('list')
    ...
    <form method="post" action=" {{ route('services.update', $service) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" dusk="title" placeholder="{{__('Title')}}" value="{{ old('title') ?? $service->title }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="description" dusk="description" placeholder="{{__('Description')}}" value="{{ old('description') ?? $service->description }}">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="price" name="price" dusk="price" placeholder="{{__('Price')}}" value="{{ old('price') ?? $service->price }}">
