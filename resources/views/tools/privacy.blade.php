            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <div class="single-feature d-flex flex-wrap justify-content-between">
                            ...
                            <h3 class="title text-uppercase pb-10">A. Korzystając z naszych usług, powierzasz nam swoje dane. Zdajemy sobie sprawę, że to wielka odpowiedzialność i bardzo się staramy zapewnić ich bezpieczeństwo oraz umożliwić Ci kontrolę nad nimi.</h3>


                        <h6 class="title text-uppercase">B. Wprowadzenie</h6>

                        <p>Z tej Polityki prywatności dowiesz się, jakie dane zbieramy i w jakim celu, a także jak możesz je aktualizować, eksportować i usuwać oraz nimi zarządzać.</p>
                        <p>
                        ...
                        <h6 class="title text-uppercase">C. Zbieranie danych osobowych</h6>
                        <p>
                        ...
                        <li>informacje wprowadzane podczas tworzenia profilu w naszej witrynie — na przykład imię i nazwisko, zdjęcia profilowe, nazwę firmy, branżę i umiejętności;</li>
                        <li>informacje, takie jak imię i nazwisko oraz adres e-mail, które podajesz w celu kupowania bonów;</li>
                        <li>informacje wprowadzane podczas korzystania z usług na naszej stronie internetowej;</li>
                        <li>informacje dotyczące wszystkiego, co kupujesz, w tym imię i nazwisko, adres, numer telefonu, adres e-mail;</li>
                        <li>informacje publikowane na naszej stronie internetowej z zamiarem opublikowania ich w Internecie, w tym nazwa użytkownika, zdjęcia profilowe i treść</li>
                        ...
                        <h6 class="title text-uppercase">D. Korzystanie z Twoich danych osobowych</h6>
                        ...
                        <h6 class="title text-uppercase">E. Ujawnianie danych osobowych</h6>
                        ...
                        <ul>
                            ...
                            <li>nabywcy (lub potencjalnemu nabywcy) jakiejkolwiek działalności lub aktywów, które sprzedajemy (lub rozważamy); i
                        ...
                        <h6 class="title text-uppercase">F. Międzynarodowe transfery danych</h6>

                        <p>Informacje, które gromadzimy mogą być przechowywane i przetwarzane w każdym z krajów, w którym prowadzimy działalność i mogą być przesyłane pomiędzy tymi krajami w celu umożliwienia wykorzystania informacji zgodnie z niniejszymi „Zasadami ochrony prywatności”.</p>
                        <p>Informacje, które zbieramy, mogą być przekazywane do następujących krajów, które nie mają przepisów o ochronie danych równoważnych z obowiązującymi w Europejskim Obszarze Gospodarczym: Stanów Zjednoczonych Ameryki, Rosji, Japonii, Chin i Indii.</p>
                        ...
                        <p style="width: 100%">Wyraźnie zgadzasz się na przekazywanie danych osobowych opisanych w tej sekcji F.<br></p>


                        <h6 class="title text-uppercase">G. Zachowywanie danych osobowych</h6>


                        <p>W Niniejszej Sekcji G określiliśmy nasze zasady i procedury dotyczące zatrzymywania danych, które mają na celu zapewnienie przestrzegania naszych zobowiązań prawnych w zakresie zachowywania i usuwania danych osobowych.</p>
                        <p>Dane osobowe, które przetwarzamy w dowolnym celu lub celach, nie będą przechowywane dłużej niż jest to konieczne do tego celu lub tych celów.</p>
                        <p>Bez uszczerbku dla artykułu G-2 zazwyczaj usuwamy dane osobowe dnia: {{ \Carbon\Carbon::now()->endOfWeek() }}.</p>
                        <p>Niezależnie od innych postanowień niniejszej sekcji G zachowamy dokumenty (w tym dokumenty elektroniczne) zawierające dane osobowe:</p>
                        <ul>
                            <li>w zakresie, w jakim jest to wymagane przepisami prawa;</li>
                        <li>jeśli uważamy, że dokumenty mogą mieć znaczenie dla wszelkich toczących się lub przyszłych postępowań sądowych; i</li>
                        <li>w celu ustanowienia, wyegzekwowania lub obrony naszych praw (wliczając w to udostępnienie informacji innym podmiotom w celu przeciwdziałania oszustwom).</li>
                        </ul>
                        <h6 class="title text-uppercase">H. Bezpieczeństwo danych osobowych</h6>
                        ...
                        <p>Będziemy przechowywać wszystkie dane osobowe, które podasz na naszych bezpiecznych serwerach (chronionych hasłem i zaporą).</p>
                        <p>Wszystkie elektroniczne transakcje finansowe zawierane za pośrednictwem naszej strony internetowej będą chronione technologią szyfrowania.</p>
                        <p>Użytkownik przyjmuje do wiadomości, że transmisja informacji przez Internet jest potencjalnie niebezpieczna i bezpieczeństwo przesłanych w ten sposób danych nie jest gwarantowane.</p>
                        <p>Jesteś odpowiedzialny za zachowanie poufności hasła używanego do uzyskania dostępu do naszej strony internetowej; nie poprosimy Cię o podanie hasła (z wyjątkiem sytuacji, gdy logujesz się na naszej stronie internetowej).</p>


                        <h6 class="title text-uppercase">I. Nowelizacje</h6>
                        ...
                        <h6 class="title text-uppercase">J. Twoje prawa</h6>
                        ...
                        <ul>
                            <li> opłaty 100zł i</li>
                            <li>dostarczenie odpowiedniego dowodu tożsamości (tym celu, zazwyczaj akceptujemy kserokopię paszportu poświadczoną przez notariusza oraz oryginalną kopię rachunku za media z aktualnym adresem).</li>
                        </ul>
                        ...
                        <h6 class="title text-uppercase">K. Strony Internetowe osób trzecich</h6>
                        ...
                        <h6 class="title text-uppercase">L. Aktualizacja informacji</h6>
                        ...
                        <h6 class="title text-uppercase">M. Ciasteczka</h6>


                        <p>Nasza strona internetowa korzysta z plików cookie. Plik cookie to plik zawierający identyfikator (ciąg liter i cyfr), który jest wysyłany przez serwer internetowy do przeglądarki internetowej i przechowywany przez przeglądarkę. Dane identyfikacyjne są ponownie przesyłane na serwer za każdym razem, gdy przeglądarka wyśle żądanie otwarcia strony znajdującej się na serwerze. Pliki cookie mogą być „trwałymi” lub „sesyjnymi” plikami cookie: trwałe pliki cookie będą przechowywane przez przeglądarkę internetową i pozostaną ważne do ustalonej daty wygaśnięcia, chyba że użytkownik usunie je przed datą wygaśnięcia; sesyjny plik cookie wygasa z końcem sesji użytkownika, gdy przeglądarka internetowa jest zamykana. Pliki cookie zazwyczaj nie zawierają żadnych informacji identyfikujących użytkownika, ale dane osobowe, które przechowujemy na Twój temat, mogą być powiązane z informacjami przechowywanymi w plikach cookie i uzyskiwanymi z nich. Używamy tylko ciasteczek sesyjnych.</p>

                        <p>Nazwy plików cookie, których używamy na naszej stronie internetowej, oraz cele, w których są wykorzystywane, są określone poniżej:</p>
                        <ul>
                            <li>
                        ...
                        <p>Większość przeglądarek pozwala odmówić przyjęcia plików cookie — na przykład:</p>
                        <ul>
