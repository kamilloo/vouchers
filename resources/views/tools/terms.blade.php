                    ...
                    <div class="single-feature d-flex flex-wrap justify-content-between">
                        ...
                        <p>Użyte w Regulaminie definicje należy rozumieć następująco:</p>
                                <ol>
                                    ...
                                    <li><strong>Wsłaściciel</strong> – Kamil Piętka, ul. Mossego 2, Grodzisk Wlkp.</li>
                                    <li><strong>Kupujący </strong>– Użytkownik, który korzysta z usług i funkcjonalności Serwisu, a w szczególności dokonujący zakupów za pośrednictwem Servisu.</li>
                                    ...
                                    <li><strong>Koszyk</strong> – element oprogramowania Serwisu, w którym widoczne są wybrane przez Kupującego Produkty do zakupu, a także istnieje możliwość ustalenia i modyfikacji danych Zamówienia, w&nbsp;szczególności ilości produktów.</li>
                                    <li><strong>Operator płatności</strong> – System płatności https://www.przelewy24.pl/</li>
                                    <li><strong>Umowa zawarta na odległość </strong>– umowa zawarta z Kupującym w ramach zorganizowanego systemu zawierania umów na odległość (w ramach Sklepu), bez jednoczesnej fizycznej obecności stron w tym samym miejscu i czasie, z wyłącznym wykorzystaniem jednego lub większej liczby środków porozumiewania się na odległość do chwili zawarcia umowy włącznie.</li>
                                    ...
                                    <li><strong>Regulamin</strong> – niniejszy regulamin Serwisu i Sklepu.</li>
                                </ol>

                        <h6 class="title text-uppercase" style="width: 100%">§ 3 Kontakt.</h6>

                                <ol>
                                    <li>Kupujący może kontaktować się ze Sprzedawcą w szczególności:
                                        <ol>
                                            ...
                                            <li>a także telefonicznie pod numerem: 662362356 w godz. 9.00 – 17.00 w dni robocze.</li>
                                        </ol>
                                    </li>
                                </ol>
                        ...
                        <h6 class="title text-uppercase" style="width: 100%">§ 4 Zagadnienia techniczne.</h6>
                                ...
                                <ol>
                                    <li>Do korzystania ze Serwisu internetowego, w tym przeglądania asortymentu Sklepu oraz składania zamówień na Produkty, niezbędne są:
                                        <ol>
                        ...
                        <h6 class="title text-uppercase">§ 5 Zasady przeglądania asortymentu oraz składania Zamówienia.</h6>

                                <ol>
                                    <li>Przeglądanie oferty Serwisu nie wymaga zakładania Konta.</li>
                                    <li>Składanie zamówień przez Kupującego na Produkty znajdujące się w asortymencie Serwisu możliwe jest:
                                        <ol>
                                            <li>przez podanie niezbędnych danych osobowych i adresowych umożliwiających realizację Zamówienia bez zakładania Konta.</li>
                                        </ol>
                                    </li>
                        ...
                        <h6 class="title text-uppercase">§ 8 Wykonanie umowy sprzedaży</h6>
                                ...
                                <ol>
                                    ...
                                    <li>Po kliknięciu przycisku “Kupuję i płacę”,
                                        <ol>
                                    ...
                                    <li>Dostawa kupionego Produktu lub świadczenie usługi następuje w sposób i w terminie wskazanym w opisie danego Produktu umieszczonym w Sklepie.</li>
                                </ol>
                        <h6 class="title text-uppercase">§ 9 Reklamacje</h6>
                                ...
                                <ol>
                                    ...
                                    <li>Brak odpowiedzi Sprzedawcy w ww. terminie na złożoną prawidłowo reklamację, oznacza uznanie reklamacji przez Sprzedającego.</li>
                        ...
                        <h6 class="title text-uppercase">§ 10 Prawo odstąpienia od umowy</h6>
                                ...
                                <ol>
                                    <li>Kupujący, będący konsumentem, który zawarł ze Sprzedawcą umowę na odległość, może w&nbsp;terminie 14 dni,
                                        <ol>
                                            <li>w przypadku Produktów fizycznych – od objęcia Produktu w posiadanie przez Kupującego lub osoby trzecie przez niego wskazane z wyjątkiem przewoźnika (np. firmy kurierskiej),</li>
                        ...
                        <h6 class="title text-uppercase">§ 13 Postanowienia końcowe</h6>
                                ...
                                <ol>
                                    ...
                                    <li>Sprzedawca zastrzega sobie prawo do dokonywania zmian Regulaminu z ważnych przyczyn, tj.: zmiany przepisów prawa, zmiany sposobów płatności i dostaw, w zakresie, w jakim te zmiany wpływają na realizację postanowień niniejszego Regulaminu. Zmiany wchodzą w życie z dniem ich publikacji w Sklepie.</li>
