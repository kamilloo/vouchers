...
namespace Tests\Unit\Domain\Payments\PaymentGateway\Pay;
...
class PaymentGatewayTest extends TestCase
{
     ...
     * @test
     */
    public function pay_create_payment_for_quote_voucher()
    {
        ...
        $this->gateway->pay($order, $this->merchant);
     ...
     * @test
     */
    public function pay_create_payment_service_voucher()
    {
        $payment_link = 'payment_link';
        $order = $this->createOrderWithServiceVoucher();

        $register_response = $this->mockRegisterResponse($payment_link);

        $this->mockTransferForServiceVoucher($register_response);
